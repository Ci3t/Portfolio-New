    ...
    <SectionShell id="about" className="border-t border-terminal-dim bg-surface-container-lowest">
      <div className="mb-12">
        ...
        <Reveal variant="mask" delay={0.1}>
          <h2 className="font-display text-headline-lg text-high-def-white">Profile</h2>
        </Reveal>
      </div>

      <div className="grid gap-12 lg:grid-cols-2">
        <Reveal delay={0.2} className="space-y-8 text-body-md text-on-surface-variant flex flex-col justify-between">
          ...
          <div className="pt-8 border-t border-terminal-dim">
            <div className="flex items-center justify-between mb-4">
              <span className="font-mono text-label-technical text-high-def-white">
